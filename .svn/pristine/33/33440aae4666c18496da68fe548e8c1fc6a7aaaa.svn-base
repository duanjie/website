...
<script type="text/javascript" src="admin/resources/js/plugins/forms/jquery.validationEngine-zh-CN.js"></script>
	...
	<div id="top">
		<div class="fixed">
			...
			<ul class="top-menu">
				...
				<li class="dropdown">
					<a class="user-menu" data-toggle="dropdown"><span><spring:message code="admin.head.good.message"/> <spring:message code="admin.login.error.password"/> ! <b class="caret"></b></span></a>
					<ul class="dropdown-menu">
						<li><a href="#" title=""><i class="icon-inbox"></i><spring:message code="admin.head.message"/></a></li>
						<li><a href="#" title=""><i class="icon-cog"></i><spring:message code="admin.head.set"/></a></li>
						<li><a href="#" title=""><i class="icon-remove"></i> <spring:message code="admin.head.logout"/> </a></li>
					</ul>
				</li>
			</ul>
		</div>
