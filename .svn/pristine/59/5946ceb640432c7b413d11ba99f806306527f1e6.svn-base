	                    	...
	                    	<div class="well row-fluid">
	                            <div class="control-group">
	                             ...
	                             <div class="control-group">
	                                ...
	                                <div class="controls">
	                                   <select name="isCover" class="styled" > 
										 <option   value="0" ${image.isCover eq "0"?"selected":""}><spring:message code="admin.image.iscover0"/></option>	
										 <option   value="1" ${image.isCover eq "1"?"selected":""}><spring:message code="admin.image.iscover1"/></option> 
										</select>  
	                                </div>
	                            </div>
	                             ...
	                             <div class="control-group">
	                                ...
	                                <div class="controls">
	                                   <input type="text" name="address" class="text" maxlength="200" value="${ image.address}"/>
