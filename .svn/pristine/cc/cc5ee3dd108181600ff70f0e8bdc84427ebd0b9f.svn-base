	                    ...
	                    <div class="widget">
	                    	...
	                    	<div class="well row-fluid">
	                            ...
	                            <div class="control-group">
	                                <label class="control-label"><spring:message code="admin.menu"/><span class="text-error">*</span></label>
	                                <div class="controls">
	                            ...
	                            <div class="control-group">
	                               ...
	                               <div class="control-group">
	                                <label class="control-label"><spring:message code="admin.article.isHtmlPage"/></label>
	                                 <div class="controls">
		                                    <select  name="isHtmlPage" class="styled">
												 <option  value='0' ${article.isHtmlPage eq 0?"selected":""}><spring:message code="admin.article.isHtmlPage.no"/></option> 
												 <option  value='1' ${article.isHtmlPage eq 1?"selected":""}><spring:message code="admin.article.isHtmlPage.yes"/></option> 
											</select>
	                                </div>
	                            </div>
					              ...
					              <c:if test="${article.isHtmlPage==0}">
	                				...
	                				<textarea name="content" id="content" rows="5" cols="5"  class="validate[required,minSize[2]] span12" >
	                					${article.content}
	                				</textarea>
	           				 	</div>
