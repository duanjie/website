...
public interface FileService {
	 ...
	 * @return 访问URL
	 */
	String upload(String path,FileType fileType, MultipartFile multipartFile, boolean async);
	 ...
	 * @return 访问URL
	 */
	String upload(String path,FileType fileType, MultipartFile multipartFile);
