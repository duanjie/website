 ...
 * Description: 文件 Service实现
 * date: 2014年5月16日 上午11:32:36 <br/>
 *
 * @author DuanJie
 * @version 1.0
 * @since JDK 1.6
...
public class FileServiceImpl implements FileService, ServletContextAware{
	...
	public String upload(String path,FileType fileType, MultipartFile multipartFile, boolean async) {
		if (multipartFile == null) {
			return null;
		}
		Setting setting = SettingUtils.get();
		...
		try {
			...
			String destPath = uploadPath + path +UUID.randomUUID() + "." + FilenameUtils.getExtension(multipartFile.getOriginalFilename());
	...
	public String upload(String path,FileType fileType, MultipartFile multipartFile) {
		return upload(path,fileType, multipartFile, false);
	}
