 ...
 * Package Name:com.lsh.site.util
 * Date:2014年4月10日下午11:01:15
 * Copyright (c) 2014, MYLSH All Rights Reserved.
 *
 */
package com.lsh.site.util;
...
import com.lsh.site.EnumConverter;
import com.lsh.site.Setting;

/**
 * 
 * ClassName: SettingUtils <br/>
 * Description: 系统设置
 * date: 2014年4月24日 下午5:29:29 <br/>
 *
 * @author DuanJie
 * @version 1.0
 * @since JDK 1.6
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File xmlFile = new ClassPathResource(
						CommonAttributes.LSH_WEB_SITE_XML_PATH).getFile();
				Document document = new SAXReader().read(xmlFile);
				@SuppressWarnings("unchecked")
				List<Element> elements = document.selectNodes("/website/setting");
	...
	public static void set(Setting setting) {
		try {
			File shopxxXmlFile = new ClassPathResource(
					CommonAttributes.LSH_WEB_SITE_XML_PATH).getFile();
