			...
			<TD width="100%">
				...
				<legend>网站建设信息</legend>
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					   <tr>
					    <td nowrap align="right">网站建设标题：</td>
						 <td>${siteInformation.emailAddress}</td>
					  </tr>
					  <tr>
					    <td nowrap align="right" width="13%">网站建设图片：</td>
					    <td width="43%">
					  ...
					  <tr>
					    <td nowrap align="right">网站建设内容：</td>
					    <td>${siteInformation.title}</td>
					  </tr>
					   <tr>
					    <td nowrap align="right">网站方向：</td>
						 <td>${siteInformation.companyAddress}</td>
					  </tr>
